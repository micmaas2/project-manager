...
| S-007-3 | pi-homelab: HA YAML syntax + Lovelace pre-commit hook (BL-108) | task-053 | done |
| S-007-4 | pensieve: n8n JSON workflow syntax pre-commit hook (BL-110) | task-054 | done |
| S-007-5 | genealogie: Python lint (ruff/black) pre-commit hook (BL-112) | task-055 | done |
| S-007-6 | genealogie: SQLite schema validator pre-commit hook (BL-113) | task-056 | done |
...
| Story ID | Title | Queue Task | Status |
|---|---|---|---|
| S-008-1 | PM system audit — CLAUDE.md, agent YAMLs, skills quality review (BL-078) | task-057 | done |
| S-008-2 | CLAUDE.md size reduction — migrate verbose sections to linked docs (BL-118) | task-058 | done |

---

## EPIC-009 — Agent & Skill Correctness Fixes

**Goal**: Fix all policy schema violations, M-1 mirror gaps, and skill authoring defects discovered by the EPIC-008 audit — ensuring every agent YAML complies with the policy schema and every PM skill matches its CLAUDE.md specification.
**Project**: project_manager
**Status**: in_progress
**MVP Phase**: MVP4
