...
| BL-122 | EPIC-008 | project_manager: Fix manager.yaml — revise-claude-md invocation uses wrong tool (subagent_type=claude-md-management:revise-claude-md); must use Skill tool per CLAUDE.md (agent tool does not work for claude-md-management:*). NOTE: steps 7b (code-quality-reviewer) and 7d (docs-readme-writer) use subagent_type correctly — do NOT change those. | project_manager | P1 | in_progress | 2026-05-03 |
| BL-123 | EPIC-008 | project_manager: Fix reviewer.yaml — require_human_approval must be true (has Write+Bash in allowed_tools; violates CLAUDE.md policy schema) | project_manager | P1 | done | 2026-05-03 |
| BL-124 | EPIC-008 | project_manager: Fix builder.yaml M-1 mirror gap — add verbatim confidence definition sentence: "confidence = certainty the finding is a real issue (not a false positive)" to Reviewer Confidence Threshold section | project_manager | P2 | in_progress | 2026-05-03 |
| BL-125 | EPIC-008 | project_manager: Fix doc-updater.yaml — require_human_approval must be true (has Write+Edit in allowed_tools; violates CLAUDE.md policy schema) | project_manager | P2 | done | 2026-05-03 |
| BL-126 | EPIC-008 | project_manager: Fix manager.yaml — prompt instructs git/python3 Bash commands but Bash absent from allowed_tools; either delegate to Builder or add Bash tool + require_human_approval: true | project_manager | P2 | in_progress | 2026-05-03 |
| BL-127 | EPIC-008 | project_manager: Add execution-mode preamble to pm-close.md — missing "do not enter plan mode" directive required by CLAUDE.md skill authoring rules for all execution-only skills | project_manager | P2 | in_progress | 2026-05-03 |
| BL-128 | EPIC-008 | project_manager: pm-start.md missing 2 of 6 CLAUDE.md mandatory session checklist items: (1) ExitPlanMode denial recovery, (2) ExitPlanMode mid-skill recovery; also catch-up SelfImprover step should run SelfImprover not just list gaps | project_manager | P2 | in_progress | 2026-05-03 |
| BL-129 | EPIC-008 | project_manager: Fix CLAUDE.md stale EPIC-003 reference in session checklist item 2 (Telegram inbox promotion) — replace hardcoded EPIC-003 with "—" (no epic; assigned during /pm-plan) to match pm-start.md behavior | project_manager | P2 | in_progress | 2026-05-03 |
