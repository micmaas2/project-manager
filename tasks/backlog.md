...
| BL-054 | EPIC-003 | pensieve: Refactor shared Claude/Parse/Build/Write Code nodes into a reusable n8n sub-workflow called by both Telegram and Gmail workflows — eliminates dual-maintenance burden (arch-review pensieve-P2) | pensieve | P2 | new | 2026-04-11 |
| BL-055 | EPIC-003 | pensieve: Add n8n health-check scheduled workflow — ping n8n API every 15 min, send Telegram alert if any active workflow has had no execution in >2h during waking hours (arch-review pensieve-P3) | pensieve | P2 | new | 2026-04-11 |
...
| BL-065 | EPIC-003 | mas_agent: Daily facts still incorrect wrt birth dates — regression or new bug after task-012 fix | pi-homelab | P1 | new | 2026-04-13 |
