...
| BL-099 | — | project_manager: Review model usage for (sub)agents — can costs be reduced by using simpler models more often? Audit current model assignments across all agents and identify downgrade opportunities | project_manager | P2 | new | 2026-04-17 |
| BL-100 | — | project_manager: Investigate interesting Claude Code skills for potential integration — research available skills, evaluate fit, propose candidates for adoption | project_manager | P2 | new | 2026-04-17 |
