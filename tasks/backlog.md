...
| BL-106 | EPIC-007 | CCAS: Ansible playbook syntax + idempotency pre-commit hook — enforce ansible-lint and validate roles are idempotent before push; linters exist but are not currently hooked | CCAS | P2 | in_progress | 2026-04-28 |
