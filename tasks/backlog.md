...
| BL-096 | — | project_manager: CLAUDE.md size reduction — 41.3k chars exceeds 40k performance threshold; audit sections for duplication, move stable reference content to linked docs, target ≤35k | project_manager | P1 | in_progress | 2026-04-17 |
| BL-097 | — | project_manager: Review /pm-run design — should it start in plan mode? Evaluate: /pm-run is task execution (not planning), so plan mode may be redundant; assess whether explicit plan-mode gate adds value or just friction for well-defined queued tasks | project_manager | P2 | in_progress | 2026-04-17 |
| BL-098 | — | project_manager: Review model version pins in CLAUDE.md — currently pinned to Opus 4.6/Sonnet 4.6/Haiku 4.5; should these be explicit versions or just family names? Update to 4.7 if explicit pins preferred, or switch to family aliases | project_manager | P2 | in_progress | 2026-04-17 |
| BL-099 | — | project_manager: Review model usage for (sub)agents — can costs be reduced by using simpler models more often? Audit current model assignments across all agents and identify downgrade opportunities | project_manager | P2 | in_progress | 2026-04-17 |
| BL-100 | — | project_manager: Investigate interesting Claude Code skills for potential integration — research available skills, evaluate fit, propose candidates for adoption | project_manager | P2 | in_progress | 2026-04-17 |
