...
| BL-061 | EPIC-003 | mas_agent: Upgrade LLM_PRIMARY_MODEL from claude-3-5-sonnet-20240620 to claude-sonnet-4-6 in mas_personal_assistant (arch-review mas-P3) | pi-homelab | P2 | in_progress | 2026-04-11 |
| BL-062 | EPIC-003 | mas_agent: Add hard budget enforcement to LLMClient.chat() — call check_budget() before each API call; raise BudgetExceededError and log if exceeded (arch-review mas-P4) | pi-homelab | P2 | in_progress | 2026-04-11 |
