...
| BL-031 | EPIC-003 | project_manager: Investigate git worktrees as isolation mechanism for parallel agent runs | project_manager | P3 | done | 2026-04-06 |
...
| BL-124 | EPIC-008 | project_manager: Fix builder.yaml M-1 mirror gap — add verbatim confidence definition sentence: "confidence = certainty the finding is a real issue (not a false positive)" to Reviewer Confidence Threshold section | project_manager | P2 | done | 2026-05-03 |
...
| BL-126 | EPIC-008 | project_manager: Fix manager.yaml — prompt instructs git/python3 Bash commands but Bash absent from allowed_tools; either delegate to Builder or add Bash tool + require_human_approval: true | project_manager | P2 | done | 2026-05-03 |
| BL-127 | EPIC-008 | project_manager: Add execution-mode preamble to pm-close.md — missing "do not enter plan mode" directive required by CLAUDE.md skill authoring rules for all execution-only skills | project_manager | P2 | done | 2026-05-03 |
